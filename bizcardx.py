...
# Adding Local path to run tesseract
pytesseract.pytesseract.tesseract_cmd = r'C:/Program Files/Tesseract-OCR/tesseract.exe'
# Establishing Connection to MySQLand creating database
mydb = pymysql.Connection(user='root', host='127.0.0.1', passwd='Dhana@123')
cur = mydb.cursor()
cur.execute('create database if not exists bizcard')
mydb = pymysql.Connection(user='root', host='127.0.0.1', passwd='Dhana@123', database='bizcard')
cur = mydb.cursor()
